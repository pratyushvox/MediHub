...
const AdminDashboard = () => {   
  ...
  const [upcomingConfirmedAppointments, setUpcomingConfirmedAppointments] = useState([]);
  ...
  const fetchAppointments = useCallback(async () => {
    try {
      ...
      setUpcomingConfirmedAppointments(upcomingConfirmed);
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 p-8 overflow-hidden">         
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            {/* Upcoming Confirmed Appointments Table */}
            <div className="bg-white rounded-lg shadow-md flex flex-col h-[400px]">
              <div className="p-4 border-b font-bold text-[#0665A7] sticky top-0 bg-white z-10">
