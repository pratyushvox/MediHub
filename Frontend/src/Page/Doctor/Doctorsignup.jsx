...
export default function DoctorSignup({ closeModal, addDoctorToList }) {
  ...
  const handleChange = (e) => {
    ...
    if (name === "price") {
      // Allow only numbers in the price field
      const formattedValue = value.replace(/\D/g, ""); 
      setDoctor((prev) => ({ ...prev, [name]: formattedValue }));
    } else {
      ...
      <div className="bg-white max-w-2xl mx-auto p-8 border rounded shadow-lg relative">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Price field with Rs formatting */}
            ...
            <div className="col-span-2 flex justify-end gap-4 mt-6">
              <button onClick={closeModal} className="border px-6 py-3 rounded" type="button">
                Cancel
              </button>
