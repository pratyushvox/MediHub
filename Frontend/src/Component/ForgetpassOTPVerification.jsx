...
const ForgetpassOtpVerification = ({ email, onClose }) => {
  ...
  const handleVerify = async () => {
    ...
    try {
      const response = await fetch(`${baseUrl}users/verify-forgotpass-otp`, {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        setVerifiedOtp(otpString); // Store the verified OTP
        setShowResetPassword(true); // Show reset password component
      } else {
  ...
  if (showResetPassword) {
    return (
      <ResetPassword
        ...
        otp={verifiedOtp} // Pass verified OTP as a prop
